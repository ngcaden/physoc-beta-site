<div class="container-fluid" style="background-color:white;">
    ...
    <div class='row'>
        ...
        <div class='col-md-7'>
            <div class='container-fluid navigation text-center'>
                <div class='row'>
                    

                    <div class='col-xs-3 col-md-3'>
                        <a style="{{ Request::is('/') ? "font-weight:bold":"" }}"  href="/" style="white-space: nowrap;">What's On</a>
                    </div>

                    <div class='col-xs-3 col-md-2'>
                        <a style="{{ Request::is('about') ? "font-weight:bold":"" }}"  href="/about">About</a>
                    </div>
                    <div class='col-xs-3 col-md-3'>
                    ...
                    <div class='col-xs-1 col-xs-offset-5 col-md-1 col-md-offset-0'>
                        <a href="https://www.facebook.com/ICPhySoc">
                            <i class="fa fa-facebook" aria-hidden="true"></i>
                        </a>
                    </div>
                    <div class='col-xs-1 col-md-1'>
                        <a href="https://twitter.com/ICPhySoc">    
